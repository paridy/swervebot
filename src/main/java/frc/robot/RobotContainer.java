...
public class RobotContainer {
  ...
  private final JoystickButton limelighButton = new JoystickButton(driver, XboxController.Button.kA.value);
  ...
  // private final JoystickButton driver_stowButton = new JoystickButton(driver,
  // XboxController.Button.kRightBumper.value);
  // private final JoystickButton driver_AutoBalance = new JoystickButton(driver,
  ...
  private void configureButtonBindings() {
    ...
    limelighButton.onTrue(
        new InstantCommand(
            () -> s_Swerve.drive(new Translation2d(limelight.getRX(), limelight.getRY()), 0, false, false)));
